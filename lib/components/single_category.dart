import 'package:e_commerce_app/screens/categories/categories_product_page.dart';
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            fit: BoxFit.cover,
          colorFilter: ColorFilter.mode(const Color(0xff0d69ff).withOpacity(1),  BlendMode.softLight,),
